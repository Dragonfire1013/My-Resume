function education() {
    ...
    const whenUgrowup = document.getElementById('careergoals');
...
function myskills() {
    ...
    const whenUgrowup0 = document.getElementById('careergoals');
...
function careergoals() {
    ...
    const whenUgrowup1 = document.getElementById('careergoals');
